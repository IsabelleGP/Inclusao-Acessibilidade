...
<body>
	...
	<div id="mapid" style="width: 1900px; height: 600px;"></div>
		<script>
			...
			L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoic3VzYW5mcmFuY2FsYXNzaSIsImEiOiJja2tpYm16bXgwbzd2MnVxOW5reWw4ZXdwIn0.9lJuJEeTkzelKqiO_VBxxg', {
				maxZoom: 18,
